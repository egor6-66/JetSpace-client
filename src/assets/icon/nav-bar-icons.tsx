...
const NavBarIcons = ({id, size, color}: NavBarIconsProps) => {

    switch (id) {
        case NavBarIconsTypes.MAIN_PAGE:
            return (
                <svg fill="none" height={size} width={size} viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
