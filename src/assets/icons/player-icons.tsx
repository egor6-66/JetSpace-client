        ...
        case 'play' :
            return (
                ...
                >
                    ...
                    <path  fill={colors?.svg?.svg} d="M24 4C12.95 4 4 12.95 4 24s8.95 20 20 20 20-8.95 20-20S35.05 4 24 4zm-4 29V15l12 9-12 9z"></path>
                </svg>
            )
        case 'pause' :
            return (
                ...
                >
                    <path fill="none" d="M0 0h48v48H0z"></path>
                    <path fill={colors?.svg?.svg} d="M24 4C12.95 4 4 12.95 4 24s8.95 20 20 20 20-8.95 20-20S35.05 4 24 4zm-2 28h-4V16h4v16zm8 0h-4V16h4v16z"></path>
                </svg>
            )
        case 'volume' :
            return (
